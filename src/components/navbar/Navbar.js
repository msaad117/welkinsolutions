            ...
            {isClick && (
                <div className={styles.mobileBar}>
                    ...
                    {!isServiceClicked ? <li className={styles.mobileServicetag} onClick={() => setIsServiceClick(!isServiceClicked)}>
                        <a style={{ textDecoration: 'none', color: "white" ,display:"flex"}} >Services  <span >{isServiceClicked ? < AiFillCaretUp /> : <AiFillCaretDown />}</span></a>

                    </li> : <li className={styles.mobileServicetag} onClick={() => setIsServiceClick(!isServiceClicked)}>
                        <a style={{ textDecoration: 'none', color: "white" ,display:"flex"}} >Services  <span style={{marginTop:"5px"}}>{isServiceClicked ? <AiFillCaretUp /> : <AiFillCaretDown />}</span></a>
                        <div className={styles.mobilemaindropdownMenu}>
                    ...
                    {!isProductClicked ? <li className={styles.mobileServicetag} onClick={() => setIsProductClick(!isProductClicked)}>
                        <a style={{ textDecoration: 'none', color: "white" ,display:"flex"}} >Products  <span>{isProductClicked ? <AiFillCaretUp /> : <AiFillCaretDown />}</span></a>
